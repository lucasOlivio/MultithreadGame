...
namespace MyEngine
{
    ...
    void ParticleEmissionSystem::Update(Scene* pScene, Entity entityId, float deltaTime)
    {
        EntityMask mask = SceneView<TransformComponent, EmitterComponent>::GetMask(*pScene);
